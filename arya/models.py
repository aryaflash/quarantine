...
class Staff(models.Model):
    ...
    name  =  models.CharField(max_length = 20, help_text = "Enter your full name")
    services = models.CharField(max_length = 100, help_text = "Enter the services you provide")
    gmail  =  models.EmailField(validators = ([EmailValidator]), blank = True, help_text = "optional")
    ...
    def __str__(self):
        return self.name+" "+self.services+" "+self.gmail+" "+str(self.phoneNumber)+" "+(self.address)+self.town+self.state+str(self.availableFrom)+str(self.availableTill)